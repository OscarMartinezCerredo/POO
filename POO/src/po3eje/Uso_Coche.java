...
public class Uso_Coche {
		...
		public static void main(String[] args) {
			...
			Subaru.establece_color(JOptionPane.showInputDialog("INTRODUCE COLOR"));
			System.out.println(Subaru.dime_color());
			Subaru.configura_asientos(JOptionPane.showInputDialog("tienes asientos"));
			System.out.println(Subaru.dime_asientos());
			
			Subaru.configura_climatizador(JOptionPane.showInputDialog("tienes climatizador o sos un motochorro"));
			System.out.println(Subaru.getClimatizador());
